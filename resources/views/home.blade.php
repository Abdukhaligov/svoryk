      ...
      <div class="col-12">
        ...
        <div class="offcanvas_menu_wrapper">
          ...
          <div class="language_currency">
            <ul>
              <li class="language"><a href="#"> Language
          ...
          <div class="call-support">
            <p><a href="tel:(08)23456789">(08) 23 456 789</a> Customer Support
            </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-7">
          <div class="widgets_container contact_us">
            ...
            <p><span>Call us:</span> <a href="tel:(08)23456789">(08) 23 456
                789</a></p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-8">
          <div class="widgets_container widget_newsletter">
            ...
            <p class="footer_desc">Get updates by subscribe our weekly
              newsletter</p>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-7">
          <div class="copyright_area">
            <p>Copyright © 2020 <a href="#">Safira</a> . All Rights
              Reserved.Design by <a href="#">Safira</a></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-5">
          <div class="footer_payment">
            <ul>
              <li>
                <a href="#"><img src="{{ asset('img/icon/paypal1.jpg') }}" alt=""></a>
              </li>
              <li>
                <a href="#"><img src="{{ asset('img/icon/paypal2.jpg') }}" alt=""></a>
              </li>
              <li>
                <a href="#"><img src="{{ asset('img/icon/paypal3.jpg') }}" alt=""></a>
              </li>
              <li>
                <a href="#"><img src="{{ asset('img/icon/paypal4.jpg') }}" alt=""></a>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div class="modal_tab">
                <div class="tab-content product-details-large">
                  <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                    <div class="modal_tab_img">
                      <a href="#"><img src="{{ asset('img/product/productbig1.jpg') }}" alt=""></a>
                    </div>
                  </div>
                ...
                <div class="modal_tab_button">
                  <ul class="nav product_navactive owl-carousel" role="tablist">
                    ...
                    <li>
                      <a class="nav-link button_three" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><img src="{{ asset('img/product/product2.jpg') }}" alt=""></a>
                    </li>
                    <li>
                      <a class="nav-link" data-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false"><img src="{{ asset('img/product/product7.jpg') }}" alt=""></a>
                    </li>
                  </ul>
                </div>
              </div>
